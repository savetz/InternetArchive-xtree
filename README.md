...
**Requirements:** the [ia command line tool](https://archive.org/developers/quick-start-cli.html), [GNU Parallel](https://opensource.com/article/18/5/gnu-parallel), and [jq](https://jqlang.github.io/jq/).
